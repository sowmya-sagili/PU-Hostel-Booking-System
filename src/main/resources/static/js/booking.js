...
document.getElementById("bookingForm").addEventListener("submit", async function (e) {
  ...
  try {
    ...
    const bookingDataForNextStep = {
      ...
      room: document.getElementById("room").options[document.getElementById("room").selectedIndex]?.text.replace("Room ", "") || "",
      bed: document.getElementById("bed").options[document.getElementById("bed").selectedIndex]?.text.replace("Bed ", "") || "",
